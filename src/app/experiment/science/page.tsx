...
import Disc from '@/app/assets/disc2.png';
const SciencePage = () => {
    return (
            ...
            <div className='flex max-md:text-center md:pl-[30%] flex-col items-center md:px-8 font-bold pb-10'>
                ...
                <ul className="space-y-6">
                    <li>
                        ...
                        <Image className='inline' alt="" src={Disc} height={40} width={40}/><strong>Just the right challenge</strong><br />
                        </div>
                    ...
                    <li>
                        <Image className='inline' alt="" src={Disc} height={40} width={40}/><strong>Team up with advanced miners</strong><br />
                        Collaborate with peers who’ve been there, done that — and are excited to share what they know.
                    </li>
                    <li>
                        <Image className='inline' alt="" src={Disc} height={40} width={40}/><strong>From class to real-life</strong><br />
