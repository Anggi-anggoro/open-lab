...
const BuildingPage = () => {
    return (
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 text-2xl px-12 h-screen text-primary">
            ...
            <div className="w-3/5">
               <div className='flex flex-col items-start text-center px-8 font-bold pb-10'>
                <div>
                    <h1 className='text-4xl'>Playful Lab</h1>
